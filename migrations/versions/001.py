...
def upgrade():
    ...
    op.create_table('dataset_concept',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('fakenodo_deposition',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('publication_type', sa.Enum('NONE', 'REGIONAL', 'NATIONAL', 'CONTINENTAL', 'OTHER', name='publicationtype'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['deposition_id'], ['fakenodo_deposition.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('file_id')
    )
    op.create_table('fakenodo_version',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('deposition_id', sa.Integer(), nullable=False),
    ...
    op.create_table('user_author_follow',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('user_community_follow',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('community_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['ds_concept_id'], ['dataset_concept.id'], ),
    sa.ForeignKeyConstraint(['ds_meta_data_id'], ['ds_meta_data.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('ds_meta_data_edit_log',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('ds_meta_data_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_table('community_dataset_proposal',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('community_id', sa.Integer(), nullable=False),
    sa.Column('dataset_id', sa.Integer(), nullable=False),
